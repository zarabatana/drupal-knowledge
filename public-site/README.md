...
```text
content/    authored editorial pages — home, trust model, CLI, about, API guide
...
Only the five files in `content/` and the two in `assets/` are authored and reviewed by hand.
